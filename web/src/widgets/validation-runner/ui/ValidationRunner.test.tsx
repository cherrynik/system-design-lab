...
describe('ValidationRunner', () => {
  ...
  it('opens saved attempts and returns to output when an attempt is selected', async () => {
    const user = userEvent.setup();
  ...
  it('reveals output for a new external validation without interrupting history browsing otherwise', async () => {
    const user = userEvent.setup();
